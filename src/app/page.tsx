  ...
  return (
    <main className="text-white">
      ...
      <nav className="fixed top-5 left-1/2 -translate-x-1/2 z-50">
        <div className="glass px-6 py-3 flex gap-6 text-sm">
      ...
      {/* HERO */}
      <section className="min-h-screen max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">

        <motion.p
          initial={{ opacity: 0, y: 25 }}
          animate={{ opacity: 1, y: 0 }}
          className="uppercase tracking-[0.3em] text-cyan-400 mb-4"
        >
